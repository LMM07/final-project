...
export default {
    ...
    methods: {
        ...
        loginWithKakao() {
            if (window.Kakao.isInitialized() == false) {
                window.Kakao.init('97a17f9847fd0a59bd966f2602972995');
            }
    ...
    mounted() {
        ...
        const naver_id_login = new window.naver_id_login("j2LwMSzFsfRp3s5lJ5e1", "http://118.67.128.140:8085/authentication/signIn/naver");
